...
function saveQuiz() {
  ...
  localStorage.setItem("ngoaiSavedQuizzes", JSON.stringify(savedQuizzes));
...
function startQuiz(id) {
  localStorage.setItem("currentNgoaiQuizId", id);
  window.location.href = "ngoai-quiz.html";
}

function deleteQuiz(id) {
  let savedQuizzes = JSON.parse(localStorage.getItem("ngoaiSavedQuizzes")) || [];
