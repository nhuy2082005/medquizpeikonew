...
function saveQuiz() {
  ...
  const savedQuizzes = JSON.parse(localStorage.getItem("sanSavedQuizzes")) || [];
  ...
  localStorage.setItem("sanSavedQuizzes", JSON.stringify(savedQuizzes));
...
function startQuiz(id) {
  localStorage.setItem("currentSanQuizId", id);
  window.location.href = "san-quiz.html";
}

function deleteQuiz(id) {
  let savedQuizzes = JSON.parse(localStorage.getItem("sanSavedQuizzes")) || [];
