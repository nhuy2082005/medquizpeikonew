...
function saveQuiz() {
  ...
  const savedQuizzes = JSON.parse(localStorage.getItem("nhiSavedQuizzes")) || [];
  ...
  localStorage.setItem("nhiSavedQuizzes", JSON.stringify(savedQuizzes));
...
function startQuiz(id) {
  localStorage.setItem("currentNhiQuizId", id);
  window.location.href = "nhi-quiz.html";
}

function deleteQuiz(id) {
  let savedQuizzes = JSON.parse(localStorage.getItem("nhiSavedQuizzes")) || [];
